  ...
  <div class="form-container w-screen h-screen">
    ...
    <div class="container" :class="{ sigin }">
      ...
      >
        ...
        <div class="flex gap-4 justify-center items-center mt-9">
          <span
            class="text-sm text-gray-600 hover:text-orange-700 hover:font-bold cursor-pointer"
...
const submitForm = async (formEl: FormInstance | undefined) => {
  await formEl?.validate(async (valid: boolean) => {
    if (valid) {
      ...
      await util.user.login(loginForm);
